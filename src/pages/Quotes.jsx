...
export default function Quotes() {
  ...
  return (
    <div>
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#004070] mb-2">Quotes</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 border-[#E6E6E6] focus:border-[#004070] focus:ring-[#004070]"
          />
        </div>
        <Button
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-gray-50 rounded-xl border border-[#E6E6E6]">
          <FileText className="w-12 h-12 text-[#004070]/30 mx-auto mb-4" />
      ...
      <AlertDialog open={!!deleteQuote} onOpenChange={() => setDeleteQuote(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="text-[#004070]">Delete Quote</AlertDialogTitle>
            <AlertDialogDescription>
